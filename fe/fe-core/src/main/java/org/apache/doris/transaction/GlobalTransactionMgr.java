...
public class GlobalTransactionMgr implements GlobalTransactionMgrIface {
    ...
    public void addDatabaseTransactionMgr(Long dbId) {
        DatabaseTransactionMgr transactionMgr;
        if (Config.enable_batch_process_txn) {
            transactionMgr = new AsyncDatabaseTransactionMgr(dbId, env, idGenerator);
        } else {
            transactionMgr = new DatabaseTransactionMgr(dbId, env, idGenerator);
        }
        if (dbIdToDatabaseTransactionMgrs.putIfAbsent(dbId, transactionMgr) == null) {
